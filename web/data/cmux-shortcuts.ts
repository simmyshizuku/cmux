    ...
    shortcuts: [
      { id: "openSettings", combos: [["⌘", ","]], description: { en: "Settings", ja: "設定" } },
      {
        ...
        description: {
          ...
          "zh-TW": "開啟團隊選擇器",
          ko: "팀 선택기 열기",
          de: "Team-Auswahl öffnen",
          es: "Abrir selector de equipos",
          fr: "Ouvrir le sélecteur d’équipes",
          it: "Apri il selettore dei team",
          da: "Åbn teamvælger",
          pl: "Otwórz wybór zespołu",
          ru: "Открыть выбор команды",
          bs: "Otvori birač tima",
          ar: "فتح محدد الفريق",
          no: "Åpne teamvelger",
          "pt-BR": "Abrir seletor de equipes",
          th: "เปิดตัวเลือกทีม",
          tr: "Ekip seçiciyi aç",
          km: "បើកកម្មវិធីជ្រើសរើសក្រុម",
          uk: "Відкрити вибір команди",
        },
      },
      ...
      {
        id: "increaseGlobalFontMagnification",
        combos: [],
        description: { en: "Increase Global Font Magnification (app UI and terminals)", ja: "グローバルフォント倍率を上げる（アプリUIとターミナル）" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "decreaseGlobalFontMagnification",
        combos: [],
        description: { en: "Decrease Global Font Magnification (app UI and terminals)", ja: "グローバルフォント倍率を下げる（アプリUIとターミナル）" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
      {
        id: "resetGlobalFontMagnification",
        combos: [],
        description: { en: "Reset Global Font Magnification to 100%", ja: "グローバルフォント倍率を100%にリセット" },
        note: { en: "unbound by default", ja: "デフォルトでは未割り当て" },
      },
